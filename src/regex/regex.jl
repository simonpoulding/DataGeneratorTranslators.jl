...
function regex_rules(regex::AbstractString, datatype::DataType=String, rulenameprefix="")
...
function regex_generator(io::IO, genname::Symbol, regex::AbstractString, datatype::DataType=String)
...
regex_generator(genname::Symbol, regex::AbstractString, datatype::DataType=String) = include_generator(genname, regex_generator, regex, datatype)